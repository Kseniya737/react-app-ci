        ...
        return (
            <>
                <ThemeProvider theme={theme}>
                    <Checkbox inputProps={{ "data-id":"blue-radio-button", "aria-label":"blue checkbox"}} {...label} sx={{
                        color: blue[800],
                        '&.Mui-checked': {
                            color: blue[600],
                        },
                    }} />
                    <Checkbox {...label} inputProps={{ "data-id":"purple-radio-button", "aria-label":"purple checkbox" }} color="secondary" />
                    <Checkbox {...label} inputProps={{ "data-id":"green-radio-button", "aria-label":"green radio button" }} color="success" />
                    <Checkbox {...label} inputProps={{ "data-id":"grey-radio-button", "aria-label":"gray radio button" }} color="default" />
